		...
		view = {
			...
			init: function (model) {
				if (typeof preventSelection == 'function') {
					...
					console.log('Sorry, but don`t have function `preventSelection`!');
				}
			...
			renderLine: function () {
				...
				console.log(this.countMonthBox);
			...
			renderMonth: function (objDate, countDays) {
				var html = '<div class="new_task" id="'+ objDate.getTime()+'"><div class="new_task_bar"></div><ul data-time="' + objDate.getTime() + '" style="width: ' + (countDays * this.configLine.widthDay) + 'px;">' +
